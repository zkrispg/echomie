...
export interface StyleListResponse { styles: StyleInfo[]; }
...
export interface MoodListResponse { items: MoodItem[]; total: number; }
...
export interface WeeklySummaryListResponse { items: WeeklySummaryItem[]; total: number; }
